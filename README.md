...
Powering on/off - When out of the menu, hold the button to turn off (the display will go blank). When off, hold button to turn on. The badge will automatically turn off after a few minutes if placed into a pocket.
